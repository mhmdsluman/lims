    ...
    <div class="flex h-screen bg-gray-100">
        ...
        >
            ...
            <nav class="mt-4 flex-1 overflow-y-auto">
                ...
                <Link v-if="['admin', 'clerk'].includes($page.props.auth.user?.role)" :href="route('reception.index')" class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-200">
                    ...
                    <span class="ml-3 whitespace-nowrap transition-opacity duration-200" :class="isSidebarCollapsed ? 'opacity-0' : 'opacity-100'">Reception</span>
                </Link>
                ...
                <Link v-if="$page.props.auth.user?.role === 'admin'" :href="route('service-commissions.index')" class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-200">
                    ...
                    <span class="ml-3 whitespace-nowrap transition-opacity duration-200" :class="isSidebarCollapsed ? 'opacity-0' : 'opacity-100'">Commissions</span>
                </Link>
                <Link v-if="$page.props.auth.user?.role === 'admin'" :href="route('payroll.index')" class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-200">
                    <svg class="h-6 w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                ...
                <Link v-if="$page.props.auth.user?.role === 'admin'" :href="route('insurance-claims.index')" class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-200">
                    <svg class="h-6 w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                    <span class="ml-3 whitespace-nowrap transition-opacity duration-200" :class="isSidebarCollapsed ? 'opacity-0' : 'opacity-100'">Insurance Claims</span>
                </Link>
